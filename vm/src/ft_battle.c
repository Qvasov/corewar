...
void	skip_op(t_vm *vm, t_cursor *cursor)
{
...
void	do_op(t_vm *vm, t_cursor *cursor, void (**op) (t_types_code, t_vm *, t_cursor *))
{
	t_types_code	args_code;
...
void	cycle(t_vm *vm, int8_t (**type) (int8_t), void (**op) (t_types_code, t_vm *, t_cursor *))
{
	t_cursor	*cursor;
...
void	ft_battle(t_vm *vm)
{
	...
	void		(*op[17])(t_types_code, t_vm *, t_cursor *);
	uint64_t	cycles;
